...
public class cargarJuegos {
    ...
    public static List cargar(ArrayList l){
        ...
        Game gameSeven =new Game("Genshin Impact","myHoYo","Genshin Impact es un juego de acción ARPG de mundo abierto free-to-play con una mecánica de monetización de Gacha para conseguir elementos adicionales como personajes especiales y armas.",R.drawable.genshin,"RPG, Sandbox",7);
